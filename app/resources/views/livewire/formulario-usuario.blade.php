    ...
    <div class="modal-dialog modal-dialog-scrollable modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-dark">
                {{-- TODO - Formulario --}}
                <form id="formulario_usuario" wire:submit.prevent="{{$accionFom}}">
                    {{-- * - NOMBRE Y ROL --}}
                    <div class="input-group mb-3">
                        ...
                        <select wire:model.lazy="rol_id" class="form-select form-control">
                            ...
                            <option value="{{ $rol_usuario->id }}" @if (isset($rol_id) && (int) $rol_id===(int)
                                $rol_usuario->id) selected @endif>{{ $rol_usuario->nombre }}
                            </option>
                            @endforeach
                        </select>
                        @endif
                    ...
                    <div class="input-group mb-3">
                        ...
                        <select wire:model.lazy="tipo_puesto" class="form-select form-control">
                            ...
                            {{-- INTERNO --}}
                            <option value="INTERNO" @if (isset($tipo_puesto) && $tipo_puesto==='INTERNO' ) selected
                                @endif>
                                INTERNO
                            </option>
                        </select>
                        ...
                        <select wire:model.lazy="nivel_puesto" class="form-select form-control">
                            ...
                            {{-- FUNCIONARIO --}}
                            <option value="FUNCIONARIO" @if (isset($nivel_puesto) && $nivel_puesto==='FUNCIONARIO' )
                                selected @endif>
                                FUNCIONARIO
                            </option>
                            {{-- ENLACE --}}
                            <option value="ENLACE" @if (isset($nivel_puesto) && $nivel_puesto==='ENLACE' ) selected
                                @endif>
                                ENLACE
                            </option>
                            {{-- OPERATIVO --}}
                            <option value="OPERATIVO" @if (isset($nivel_puesto) && $nivel_puesto==='OPERATIVO' )
                                selected @endif>
                                OPERATIVO
                            </option>
                        </select>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <div class="input-group-text">
                            <input class="form-check-input mt-0" type="checkbox" wire:model.lazy="{{ $estudio }}">
                        </div>
                        @endforeach
                    </div>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <span class="input-group-text">
                            <button type="button" class="btn btn-outline-dark border"
                                wire:click="$toggle('mostrar_pass')">
